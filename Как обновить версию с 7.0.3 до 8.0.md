...
> [!Warning]
> После успешного обновления не забудьте вернуть переход «режим обслуживания» иконка вашего хоста изменится. Иначе не запустится не одна виртуальная машина.
